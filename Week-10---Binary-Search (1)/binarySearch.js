...
const searchForAlphabeticalIndex = ([stringToFindIndexForFirstLetter], alphabetArray = generateAlphabetArray()) => {
    ...
    for (let i = 0; i < alphabetArray.length; i++) {
        ...
        linearSearchResults++;
        if (alphabetArray[i] === stringToFindIndexFdorFirstLetter) {
    ...
    let recursiveBinarySearch = (array, letter, startIndex, endIndex) => {
        ...
        if (array[midIndex] === letter) {
          binarySearchCharacterIndex = array[midIndex];
          return true;
        }
    ...
    const binarySearchAl = document.getElementById('searchFor') || {};
    const binarySearchAl1 = document.getElementById('searchFor1') || {};
    binarySearchAl1.innerText += " " + linearSearchResults;
    const binarySearchAl2 = document.getElementById('searchFor2') || {};
    binarySearchAl2.innerText += " " + binarySearchResults;
